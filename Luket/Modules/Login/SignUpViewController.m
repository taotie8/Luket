...
- (void)setupViews {
    ...
    self.signUpButtonImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"SignUpButton"]];
    ...
    [self.signUpButtonImageView addGestureRecognizer:signUpTap];
...
- (void)layoutViews {
    ...
    self.topCardView.frame = CGRectMake(20.0, topCardY, topCardWidth, 52.0);
    ...
    self.signUpButtonImageView.frame = CGRectMake((cardWidth - 318.0) / 2.0, 356.0, 318.0, 51.0);
}
